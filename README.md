...
|팀원|느낀점|
|-----|---|
|고요한|k : 팀원들의 즉각적인 피드백 및 의견공유를 통해 프로젝트 진행 속도를 끌어올리고 기존 설계한 방향에 대한 문제점이 생기면 빠르고 유연한 방향수정이 가능하였다.
p: jira 협업툴을 좀 더 자세하고 적극적으로 사용하였으면 좋았을 것이다.
t: 적극적인 소통을 통해서 프로젝트의 팔로우업을 유지하였고 협업툴을 통해서 그 과정을 체계적인 기록을 통해 효율적인 시간관리가 될 수 있도록 해야한다.|
|염진호|내용|
|유광석|내용|
